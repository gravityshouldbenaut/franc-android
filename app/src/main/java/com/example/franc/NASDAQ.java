...
public class NASDAQ extends ActionBarActivity {
    private ListView nasdaqStocks;
    private URL url;
    @Override
...
//        webview.loadUrl("http://articlefeeds.nasdaq.com/nasdaq/categories?category=Stocks&format=xml");
        nasdaqStocks = (ListView) findViewById(R.id.nasdaqStocks);
        try {
            url = new URL(
                    "http://articlefeeds.nasdaq.com/nasdaq/categories?category=Investing%20Ideas&format=xml");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_nasdaq, menu);
        return true;
